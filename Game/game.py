...
running = True
worldmap = WorldMap(Viewport(),window_width,window_height,window)
Level1 = Level_01_State(Viewport(),Wallet(),clock,worldmap)
tutorial = Tutorial(window_width,window_height,window,Level1)
while running:
    if worldmap.run:
        if track == 1:
            gunna_channel.pause()
