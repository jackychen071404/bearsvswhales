...
class Level_01_State:
    def __init__(self,viewport,wallet):
        self.gamestart = True
        #self.bg_music = pygame.mixer.Sound("GUNNA.mp3")
        self.map_width = 2000
        self.map_height = 800
        self.background_image = pygame.transform.scale(pygame.image.load("Tower_BGs/back.png").convert(), (self.map_width, self.map_height))
        ...
        self.coin_icon = pygame.image.load("ButtonPics/moneyIcon.png")  # 125 x 30
        self.coin_rect = pygame.image.load("ButtonPics/moneyIcon.png").get_rect(topleft=(5, 750))  # 125 x 30
        #towers
    ...
    def update(self):
        ...
        if self.tower1.sprite.health == 0:
            ...
            text_rect = self.tower1.sprite.image.get_rect(topleft=(600, 400))
